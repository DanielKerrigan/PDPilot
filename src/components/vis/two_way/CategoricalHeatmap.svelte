<script lang="ts">
  ...
  import { drawCategoricalHeatmap } from '../../../drawing';
  ...
  export let pdp: CategoricalDoublePDPData;
  ...
  /*
  If scaleCanvas is called after drawCategoricalHeatmap, then it will clear the canvas.
