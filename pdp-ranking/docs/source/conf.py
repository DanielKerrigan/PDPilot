...
# -*- coding: utf-8 -*-
#
# pdp_ranking documentation build configuration file
#
...
_version_py = os.path.join(repo, 'pdp_ranking', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'pdp_rankingdoc'
...
latex_documents = [
    (master_doc, 'pdp_ranking.tex', 'pdp_ranking Documentation',
     'Rachel Kalafos', 'manual'),
]
